...
Bigint::Bigint(long num, unsigned long size)
{
    ...
    lastDigitIndex_ = -1;
    //int t = (int)std::abs((double)num);   // if <cmath> included
    int t = std::abs(num);
    while (t > 0) {
        lastDigitIndex_++;
...
///////////////////////////////////////////////////////////////////////////
Bigint& Bigint::shiftRight(int d = 1)
// divide by 10^d
{
    if ((lastDigitIndex_ == 0) && (vDigits_[0] == '0')) 
        return (*this);
    ...
    for (int i = 0; i <= lastDigitIndex_ - d; ++i)
        vDigits_[i] = vDigits_[i+d];
...
int main()
{
    ...
    // constructors
    Bigint b1(123), b2(-1), b4(-1000);
    cout << "Initialized 2 bigints b1 = 123 and b2 = -1 and b4 = -1000" << endl;
    cout << "b1 = " << b1 << ", b2 = " << b2 << ", b4 = " << b4 << endl;

    // operator overloads
    cout << (Bigint(111) / 8) * 8 << endl;

    cout << Bigint(5).factorial() << endl;

    Bigint b3 = b1 + 100;
    cout << "Adding b3 = b1 + 100" << " = " << b3 << endl;

    b3 = 100 + b1;
    cout << "Adding b3 = 100 + b1" << " = " << b3 << endl;

    b3 = b1 + b1;
    cout << "Adding b3 = b1 + b1" << " = " << b3 << endl;

    b3 = b1 + b2;
    cout << "Adding b3 = b1 + b2" << " = " << b3 << endl;

    b3 = b2 + b2;
    cout << "Adding b3 = b2 + b2" << " = " << b3 << endl;

    b3 = b1 - 1000;
    cout << "Adding b3 = b1 - 1000" << " = " << b3 << endl;

    b3 = b1 + b4;
    cout << "Adding b3 = b1 + b4" << " = " << b3 << endl;

    b3 = b1 * 100;
    cout << "Multiplying b3 = b1 * 100" << " = " << b3 << endl;

    b3 = 100 * b1;
    cout << "Multiplying b3 = 100 * b1" << " = " << b3 << endl;

    b3 = b1 * b1;
    cout << "Multiplying b3 = b1 * b1" << " = " << b3 << endl;

    b3 = b1 * b2;
    cout << "Multiplying b3 = b1 * b2" << " = " << b3 << endl;

    b3 = b2 * b2;
    cout << "Multiplying b3 = b2 * b2" << " = " << b3 << endl;

    b3 = 2 * b2 / b2;
    cout << "b3 = 2 * b2 / b2" << " = " << b3 << endl;

    b3 = b2 * 2 / b2;
    cout << "b3 = b2 * 2 / b2" << " = " << b3 << endl;

    b3 = b2 / b2;
    cout << "b3 = b2 / b2" << " = " << b3 << endl;

    b3 = b4 / b2 / b1;
    cout << "b3 = b4 / b2 / b1" << " = " << b3 << endl;

    b3 = b1 ^ 5;
    cout << "b3 = b1 ^ 5" << " = " << b3 << endl;
    ...
    b3 = b1 * b1;
    cout << "b3 = b1 * b1" << " = " << b3 << endl;

    b3 = Bigint("12345678901234567890");
    ...
    b3 %= 10;
    cout << "mod " << b3 << endl;
    cout << Bigint(120).shiftRight() << endl;
    cout << Bigint(120).shiftLeft() << endl;


    try {
        b3 /= 0;
        cout << "Dividing b3 /= 0" << " = " << b3 << endl;
    } catch (const DivideByZeroException& e) {
        cout << e.what() << endl;
        cout << "Dividing b3/= 0 = DivideByZeroException thrown" << endl;
    }

    try {
        b3 = b2 / Bigint(0);
        cout << "Dividing b3 = b2 / 0" << " = " << b3 << endl;
    } catch (const DivideByZeroException& e) {
        cout << e.what() << endl;
        cout << "Dividing b3 = b2 / 0 = DivideByZeroException thrown" << endl;
    }
