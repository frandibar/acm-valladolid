...
// TODO: factorizar n. ver p153 programming challenges
////////////////////////////////////////////////////////////////////////////////
void process(vector<int>& vResults, int n)
...
int main(int argc, char *argv[])
{
    ...
    // PROCESS
    vector<int> vResults(max + 1);
    process(vResults, max);

    // SHOW OUTPUT
    for (int i = 0; i < (int)vInput.size(); ++i)
        cout << setw(5) << vInput[i] << " -> " << vResults[vInput[i]] << endl;
