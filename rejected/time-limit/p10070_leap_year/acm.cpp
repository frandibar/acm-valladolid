...
#define BULUCULU	"This is bulukulu festival year."
...
////////////////////////////////////////////////////////////////////////////////
inline bool leap_year(const bigint& year)
{
	if (year % 4 == 0)
		if (year % 400 == 0)
			return true;
...
////////////////////////////////////////////////////////////////////////////////
inline void year_type(const bigint& year, bool *leap, bool *hulu, bool *bulu)
{
	*leap = leap_year(year);
	*hulu = (year % 15 == 0);
	*bulu = (*leap && (year % 55 == 0));
...
int main(int argc, char *argv[])
{
	...
	while (!cin.eof()) {
		...
		std::getline(cin, line);
		if (!cin.eof() && (line.find_first_of("0123456789") != string::npos)) 
			cout << endl;
	}
