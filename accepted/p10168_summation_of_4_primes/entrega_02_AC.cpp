...
///////////////////////////////////////////////////////////////////////////
bool is_prime(int64 n, vector<int64>& vec_primes)
// N is prime <=> not divisible by any prime number in range 2..sqrt(N)
{
	int i = 0;
	while (vec_primes[i]*vec_primes[i] <= n) {
		if (n % vec_primes[i] == 0)
			return false;
		else
			i++;
...
int main(int argc, char *argv[])
{
	...
	const long MAX = 447;	// precalculated primes
	// there are MAX primes under sqrt(10.000.000)
