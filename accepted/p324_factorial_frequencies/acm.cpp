/* @JUDGE_ID:  40922FK  324  C++  */
/* @BEGIN_OF_SOURCE_CODE */    
/**************************************************************************
 Solution to Problem 324 - Factorial Frequencies
 by: Francisco Dibar
 date: Aug-06-2006
**************************************************************************/
...
int main(int argc, char *argv[])
{
	...
	while (!cin.eof() && (n != 0)) {
        // PROCESS
		string temp(Bigint(n).factorial().toString());
		vector<int> vHist(10);
		...
		cout << n << "! --" << endl;
        // show table
        cout << "   (0)" << setw(5) << vHist[0];
        cout << "    (1)" << setw(5) << vHist[1];
        cout << "    (2)" << setw(5) << vHist[2];
        cout << "    (3)" << setw(5) << vHist[3];
        cout << "    (4)" << setw(5) << vHist[4] << endl;
        cout << "   (5)" << setw(5) << vHist[5];
        cout << "    (6)" << setw(5) << vHist[6];
        cout << "    (7)" << setw(5) << vHist[7];
        cout << "    (8)" << setw(5) << vHist[8];
        cout << "    (9)" << setw(5) << vHist[9] << endl;
