...
////////////////////////////////////////////////////////////////////////////////
long convertir_a_nro(string pieza)
{
	long nro = 0;
	for (int i=0; i < DIM; i++) 
		if (pieza[DIM-1-i] != V)
...
////////////////////////////////////////////////////////////////////////////////
string convertir_a_letra(long pieza, char letra)
{
	long masc = 1;
	string letras = VACIO;
	for (int i=0; i < DIM; i++) {
...
public:
	...
	long &pieza_a() { return m_iPieza_a; }
	long &pieza_b() { return m_iPieza_b; }
	long &pieza_c() { return m_iPieza_c; }
	long &pieza_d() { return m_iPieza_d; }
	long &pieza_e() { return m_iPieza_e; }
	long &pieza_f() { return m_iPieza_f; }
	long &pieza_g() { return m_iPieza_g; }	
