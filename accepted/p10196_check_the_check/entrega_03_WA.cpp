...
///////////////////////////////////////////////////////////////////////////
inline int rook(char mat_tablero[][8], int i, int j, int ki, int kj, 
				int king, char rey_atacado)
{
	// izquierda y derecha
	if (i == ki) {
...
///////////////////////////////////////////////////////////////////////////
inline int bishop(char mat_tablero[][8], int i, int j, int ki, int kj, 
					int king, char rey_atacado)
{
	// antidiagonal (\)
	if (ki - kj == i - j) {
...
//////////////////////////////////////////////////////////////////////////
inline int knight(char mat_tablero[][8], int i, int j, int ki, int kj, 
					int king, char rey_atacado)
{
...
///////////////////////////////////////////////////////////////////////////
int under_check(char mat_tablero[][8], int i, int j, int ki, int kj, 
				int king)
{
	char rey_atacado;
	...
	switch (mat_tablero[i][j]) {
		...
		case WQ:	case BQ:		// reina
			int rook_check = 
				rook(mat_tablero, i, j, ki, kj, king, rey_atacado);
			return (rook_check != NO_CHECK ? 
					rook_check : 
					bishop(mat_tablero, i, j, ki, kj, king, rey_atacado));
			break;
	}
