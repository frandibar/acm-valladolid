/* @JUDGE_ID:  40922FK  424  C++  */
/* @BEGIN_OF_SOURCE_CODE */    
/**************************************************************************
 Solution to Problem 424 - Integer Inquiry
 by: Francisco Dibar
 date: Feb-16-2005
**************************************************************************/
...
///////////////////////////////////////////////////////////////////////////
bigint bigint::operator*(const bigint &nro) const	// REVISAR
{
	bigint res;
	bigint row = *this;
...
int main(int argc, char *argv[])
{
	...
	bigint x;
	// nota: no se controla que el fin del input lo de un cero
	while (!cin.eof()) {
		bigint y;
		cin >> y;
		x += y;
