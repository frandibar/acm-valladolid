/* @JUDGE_ID:  40922FK  10359  C++  */
/* @BEGIN_OF_SOURCE_CODE */    
/**************************************************************************
 Solution to Problem 10359 - Tiling
 by: Francisco Dibar
 date: Mar-17-2005
**************************************************************************/
...
///////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
bigint tiling(int n, int *max, vector<bigint>& vec_fibo)
// vec_fibo es un vector de la serie precalculada (max valores)
{
	if (n >= *max) {
		...
		vec_fibo.resize(n+1);
		for (int i = *max; i <= n; i++)
			vec_fibo[i] = vec_fibo[i-1] + (bigint)2 * vec_fibo[i-2];
		*max = n;
	}
	return vec_fibo[n];
}
...
int main(int argc, char *argv[])
{
	...
	int n, 
		 max = 3;		// cant de valores precalculados
	cin >> n;
	vector<bigint> vec_fibo(max);		// valores precalculados
	...
	while (!cin.eof()) {
		cout << tiling(n, &max, vec_fibo) << endl;
		cin >> n;
	}
	return 0;
}
