/* @JUDGE_ID:  40922FK  355  C++  */
/* @BEGIN_OF_SOURCE_CODE */    
/**************************************************************************
 Solution to Problem 355 - The Bases are Loaded
 by: Francisco Dibar
 date: Mar-11-2005
**************************************************************************/
...
// condicion: b <= 16
{
	...
	if (b > 16) return bigint(0);		// Restriccion
...
int main(int argc, char *argv[])
{
	...
	while (!cin.eof()) {
		if (nro.base_ok(b1))
			cout << nro << " base " << b1 << " = " 
					<< nro.cambio_base(b1, b2) << " base " << b2 << endl;
		else
			cout << nro << " is an illegal base " << b1 << " number" << endl;
		cin >> b1 >> b2 >> nro;
	}
	return 0;
}
