/* @JUDGE_ID:  40922FK  10077  C++  */
/* @BEGIN_OF_SOURCE_CODE */    
/**************************************************************************
 Solution to Problem 10077 - The Stern-Brocot Number System
 by: Francisco Dibar
 date: Feb-22-2005
**************************************************************************/
...
///////////////////////////////////////////////////////////////////////////
// codigo extraido de 
// "p.122 Concrete Mathematics - Graham - Knuth - Pat."
string stern_brocot(bigint m, bigint n)
{
	string sb;
	while (m != n) {
		if (m < n) {
...
int main(int argc, char *argv[])
{
	...
	bigint m, n;
	cin >> m >> n;
	while (!cin.eof() && ( n != 1 || m != 1)) {
		cout << stern_brocot(m, n) << endl;
		cin >> m >> n;
	}
	return 0;
}
